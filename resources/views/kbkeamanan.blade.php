...
@keyframes jalanKanan {
  ...
  <div class="max-w-6xl mx-auto px-4 md:flex md:items-center md:gap-10">
    <div class="md:w-1/2">
      <img src="img/ekd.png" alt="koding" class="rounded-xl shadow-lg">
    </div>
    <div class="md:w-1/2 mt-8 md:mt-0">
      <h2 class="text-3xl font-bold text-gray-800 mb-4">APA ITU <span class="text-blue-700">ETIKA & KEAMANAN DIGITAL?</span></h2>
      <p class="text-gray-700 text-lg leading-relaxed">
        <strong>Etika & Keamanan Digital.</strong> Etika adalah cara kita bersikap baik dan sopan saat menggunakan internet atau alat digital. Misalnya, tidak menyebarkan berita bohong, tidak berkata kasar di media sosial, dan tidak mencuri hasil karya orang lain. Seperti di dunia nyata, kita harus saling menghormati dan bertanggung jawab saat beraktivitas di dunia digital.
        Keamanan digital adalah cara kita menjaga diri supaya tetap aman saat menggunakan internet. Contohnya, tidak sembarangan membagikan nama lengkap, alamat, atau kata sandi ke orang lain. Kita juga harus hati-hati saat mengklik link, karena bisa jadi itu jebakan yang berbahaya. Menggunakan kata sandi yang kuat dan tidak mudah ditebak juga termasuk menjaga keamanan digital.<p class="text-gray-700 text-lg leading-relaxed mt-4">
        Nah, Ayo kita sama-sama pelajari tentang etika & kemanan digital/home/syela/Downloads/ekd.png /home/syela/Downloads/ai.png. Pastikan ambil kelas sesuai tingkatanmu ya, agar kamu mudah memahami materinya dan bisa menjawab soal dengan benar. Semangat!</p>
    </div>
  </div>
</section>
<section class="bg-white py-16 px-4 md:px-8"
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
    ...
    <a href="/kbkoding" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/sd.png" alt="SD" class="h-16 mx-auto mb-4">
    ...
    <a href="/kbka" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/smp.png" alt="SMP" class="h-16 mx-auto mb-4">
    ...
    <a href="/kbkeamanan" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/sma.png" alt="SMA" class="h-16 mx-auto mb-4">
    ...
    <a href="/kbkeamanan" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/smk.png" alt="SMK" class="h-16 mx-auto mb-4">
