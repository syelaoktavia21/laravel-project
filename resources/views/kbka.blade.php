...
@keyframes jalanKanan {
  ...
  <div class="max-w-6xl mx-auto px-4 md:flex md:items-center md:gap-10">
    <div class="md:w-1/2">
      <img src="img/ai.png" alt="koding" class="rounded-xl shadow-lg">
    </div>
    <div class="md:w-1/2 mt-8 md:mt-0">
      <h2 class="text-3xl font-bold text-gray-800 mb-4">APA ITU <span class="text-blue-700">KECERDASAN ARTIFISIAL?</span></h2>
      <p class="text-gray-700 text-lg leading-relaxed">
        <strong>Kecerdasan Artifisial</strong> atau AI adalah saat komputer bisa "berpikir" dan "belajar" sendiri seperti manusia. AI bisa mengenali suara, memahami gambar, menjawab pertanyaan, atau bahkan bermain game tanpa diberi perintah satu per satu. Contohnya seperti robot yang bisa bicara, aplikasi yang bisa mengenali wajah, atau mobil yang bisa menyetir sendiri. Semua itu bisa terjadi karena AI belajar dari banyak data, lalu membuat keputusan sendiri berdasarkan pengalaman itu.
        <p class="text-gray-700 text-lg leading-relaxed mt-4">
        Nah, Ayo kita sama-sama pelajari tentang kecerdasan artifisial. Pastikan ambil kelas sesuai tingkatanmu ya, agar kamu mudah memahami materinya dan bisa menjawab soal dengan benar. Semangat!</p>
    </div>
  </div>
</section>
<section class="bg-white py-16 px-4 md:px-8"
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
    <!-- Program Item -->
    <a href="/kasd" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/aisd.png" alt="SD" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">SD</h4>
      <p class="text-gray-700 text-sm">Program pembelajaran kecerdasan artifisial tingkat SD.</p>
    </a>

    <a href="/kbka" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/aismp.png" alt="SMP" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">SMP</h4>
      <p class="text-gray-700 text-sm">Program pembelajaran kecerdasan artifisial tingkat SMP</p>
    </a>

    <a href="/kbkeamanan" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/aisma.png" alt="SMA" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">SMA</h4>
      <p class="text-gray-700 text-sm">Program pembelajaran kecerdasan artifisial tingkat SMA</p>
    </a>

    <a href="/kbkeamanan" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/aismk.png" alt="SMK" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">SMK</h4>
      <p class="text-gray-700 text-sm">Program pembelajaran kecerdasan artifisial tingkat SMK</p>
    </a>
  </div>
</section>
  </body>
