...
@keyframes jalanKanan {
  ...
  <div class="max-w-6xl mx-auto px-6 md:flex md:items-center md:gap-10">
    <div class="md:w-1/2">
      <img src="img/kbfoto.jpeg" alt="Ilustrasi Kaltim Belajar" class="rounded-xl shadow-lg">
    </div>
    <div class="md:w-1/2 mt-8 md:mt-0">
      <h2 class="text-3xl font-bold text-gray-800 mb-4">Tentang <span class="text-blue-700">Kaltim Cerdas Digital</span></h2>
      <p class="text-gray-700 text-lg leading-relaxed">
        <strong>Kaltim Cerdas Digital</strong> adalah inisiatif pembelajaran modern berbasis teknologi digital untuk siswa Kalimantan Timur dari semua jenjang (Fase B–F).
        Platform ini menyajikan materi seputar Pemrograman Dasar, Kecerdasan Artifisial, serta Etika & Keamanan Digital dengan metode interaktif, visual, dan mudah dipahami.
      </p>
      <p class="text-gray-700 text-lg leading-relaxed mt-4">
        Kami percaya bahwa generasi muda Kalimantan Timur berhak mendapatkan akses ke ilmu digital masa depan untuk menjadi <em>literat, cakap teknologi, dan etis</em> dalam dunia yang semakin terkoneksi.
      </p>
    </div>
  </div>
</section>
<section class="bg-white py-16 px-4 md:px-8"
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <a href="/kbkoding" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/kbkoding.png" alt="KB Media" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">Koding</h4>
      <p class="text-gray-700 text-sm">Kelas ini dirancang untuk mengenalkan dunia pemrograman kepada siswa dari Fase B hingga F. Anak-anak akan belajar cara membuat halaman web sederhana menggunakan HTML serta memahami dasar-dasar logika pemrograman melalui Python.</p>
    </a>

    <a href="/kbka" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/kbka.png" alt="KB Budaya" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">Kecerdasan Artifisial</h4>
      <p class="text-gray-700 text-sm">Dalam kelas ini, siswa akan diajak mengenal kecerdasan artifisial dengan pendekatan sederhana dan ramah anak. Mereka akan belajar bagaimana mesin bisa mengenali suara, gambar, atau gerakan menggunakan platform seperti Teachable Machine.</p>
    </a>

    <a href="/kbkeamanan" class="text-center p-6 bg-blue-50 rounded-xl shadow hover:shadow-md transition">
      <img src="/img/kbkeamanan.png" alt="KB Kelas" class="h-16 mx-auto mb-4">
      <h4 class="text-lg font-semibold text-blue-800 mb-2">Etika & Keamanan Digital</h4>
      <p class="text-gray-700 text-sm">Kelas ini membantu siswa memahami pentingnya bersikap baik dan aman di dunia digital. Mereka akan belajar tentang etika saat berkomunikasi di internet, menjaga privasi, mengenali informasi palsu, serta memahami apa itu jejak digital.</p>
    </a>
  </div>
</section>
  </body>
