          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 card fade-in">
              ...
              <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">Pelajari konsep dasar transformasi digital dan penerapannya dalam pendidikan untuk meningkatkan kualitas pembelajaran di Kalimantan Timur.</p>
            ...
            <div class="space-y-6 fade-in animate-delay-100">
              <div class="card p-6 bg-gradient-to-br from-blue-50 to-indigo-50">
                ...
                <div class="space-y-4">
                  <a href="#" class="flex items-start group">
                    ...
                    <div class="ml-3">
                      <h4 class="text-sm font-medium text-gray-800 group-hover:text-blue-600">Transformasi Pendidikan Digital</h4>
                  ...
                  <a href="#" class="flex items-start group">
                    ...
                    <div class="ml-3">
                      <h4 class="text-sm font-medium text-gray-800 group-hover:text-blue-600">Strategi Pembelajaran Online</h4>
              ...
              <div class="card p-6 bg-gradient-to-br from-indigo-50 to-purple-50 text-center fade-in animate-delay-200">
                ...
                <a href="/soal" class="btn-primary inline-block">
